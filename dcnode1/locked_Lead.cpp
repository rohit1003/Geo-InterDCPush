...
int main(){
	...
	string str_port_L1	 = config_read("DC1_PORT_LEAD_L1");
  	...
  	string str_IP_cross_lead	= config_read("DC2_LEAD_IP");
  	string str_port_cross_lead	= config_read("DC2_PORT_LEAD_LEAD");
  	string str_port_cross_lead_recv =config_read("DC1_PORT_LEAD_LEAD");
